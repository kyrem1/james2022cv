...
\begin{center}
  I am a first-year undergraduate at the University of Virginia with a comprehensive undergraduate and graduate-level mathematics background. My primary interests are algebraic geometry and graph theory.
\end{center}
...
\cventry{A+}{MTG 4254}{Differential Geometry}{Fall 2020}{Thomas Bieske}%
  {Description \\ \emph{Textbook: }O'Neill's \emph{Elementary Differential Geometry}.}
...
\cventry{A+}{MAA 4211}{Intermediate Analysis I}{Spring 2020}{Boris Shekhtman}%
  {Ordered fields, real number system. General metric topology, compactness, sequences and series, continuity, connectness, intermediate value theorem, uniform convergence, derivatives, and the Riemann integral. \\ \emph{Textbook: }Rudin's \emph{Principles of Mathematical Analysis}.}
