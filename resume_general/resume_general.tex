...
\textbf{Proficient In} Java, C, C++, Assembly, Python, Javascript, \LaTeX, SageMath, Mathematica. I have also taken courses in financial engineering, algorithmic economics, computer architectures, and machine learning.
