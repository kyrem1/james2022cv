...
\begin{itemize}
  ...
  \item \textbf{Graduate level courses taken}: Functional Analysis, Measure Theory, Complex Analysis, Differential Topology, Algebraic Geometry, Algebra II, Algebra I, Applied Partial Differential Equations.
\end{itemize}
