...
\cventry{\emph{current}}{MATH 7752}{Algebra II}{Spring 2022}{Evangelia Gazaki}%
...
\cventry{\emph{current}}{MATH 7800}{Algebraic Topology I}{Spring 2022}{Nicholas Kuhn}%
  {Graduate algebraic topology course covering homology and homotopy theory.  \\ \emph{Textbook: }Hatcher, Vick}

  \cventry{\emph{current}}{MATH 7310}{Real Analysis and Linear Spaces}{Spring 2022}{Benjamin Hayes}%
  {Graduate measure theory course covering abstract measure spaces, integration, modes of convergence, Banach and Hilbert space techniques, $L^p$-spaces. \\ \emph{Textbook: }Folland's \emph{Real Analysis} (1-3,5,6).}
...
\begin{itemize}
  ...
  \item Pi Mu Epsilon, University of South Florida (as a high-school freshman).
\end{itemize}
